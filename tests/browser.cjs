...
(async()=>{
 ...
 try{
  ...
  await page.click('#duplicateBtn');assert.equal(await page.locator('.clip-item').count(),4);await page.click('#undoBtn');assert.equal(await page.locator('.clip-item').count(),3);await page.click('#redoBtn');assert.equal(await page.locator('.clip-item').count(),4);await page.click('#deleteBtn');await page.click('#confirmDeleteClip');assert.equal(await page.locator('.clip-item').count(),3);log('duplicate, undo, redo and remove');
